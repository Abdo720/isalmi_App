...
import 'package:islamy/screens/surs_details/sura_details_screen.dart';
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return Recentsura(
                    recntely: DataSuraList(
                      NameAr: surahNamesArabic[index],
                      NameEn: surahNamesEnglish[index],
                      NumberVerses: versesCount[index],
                      index: index,
                    ),
                  );
                },
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        SuraDetailsScreen_State.routeName,
                        arguments: DataSuraList(
                          NameAr: surahNamesArabic[index],
                          NameEn: surahNamesEnglish[index],
                          NumberVerses: versesCount[index],
                          index: index,
